...
namespace Managerment.Controllers
{
    ...
    {
        private readonly ProductConditionAppService _productConditionAppService;
        public ProductConditionController(ProductConditionAppService productConditionAppService)
        {
