...
namespace Managerment.Migrations
{
    ...
    [Migration("20220726153408_database-noaction")]
    partial class databasenoaction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Managerment.CashRecieptOthers.CashReceiptOther", b =>
                {
                    ...
                    b.Property<Guid>("ID_reciept_type")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Managerment.CashRecieptTypes.CashReceiptType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("CRT_name")
                        .IsRequired()
                        .HasMaxLength(255)
                    ...
                    b.ToTable("AppCashReceiptTypes", (string)null);
                });
            ...
            modelBuilder.Entity("Managerment.TypeRepairs.TypeRepair", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppTypeRepairs", (string)null);
                });
            ...
            modelBuilder.Entity("Managerment.ProductRepairs.ProductRepair", b =>
                {
                    b.HasOne("Managerment.TypeRepairs.TypeRepair", null)
                        .WithMany()
